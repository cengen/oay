...
var samarbeidspartnereDataService = (function () {
    ...
    var
        ds = {
            ...
            del: function (data) {
                return this.commit(httpVerbs.DEL, "/api/samarbeidspartnere/" + data.samarbeidspartnerId);
            },

            save: function (data) {
                var
                    type = httpVerbs.POST,
                    url = "/api/samarbeidspartnere";
            ...
            saveImage: function (data) {
                return $.ajax({                  
                    type: httpVerbs.POST,
                    url: "/samarbeidspartnere/lastoppbilde",
                    processData: false,
                    contentType: false,
                    traditional: true,
                    async:   false,
            ...
            deleteImage: function (data) {
                return $.ajax({
                    type: httpVerbs.DEL,
                    url: "/samarbeidspartnere/slettbilde",
                    data: data
                });
            }
